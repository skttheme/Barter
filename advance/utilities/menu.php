...
if(!function_exists('barter_add_menu_parent_class')){
	/**
	 ...
	 * @return array
	 */
	function barter_add_menu_parent_class( $items ) {
...
add_filter( 'wp_nav_menu_objects', 'barter_add_menu_parent_class' );


if(!function_exists('barter_page_menu')){
	/**
	 ...
	 */
	function barter_page_menu($only_check = false) {
        global $post;
        ...
        if($there_is_menu){
            ...
            $list_pages_params['walker'] = new BARTER_list_pages_walker;
