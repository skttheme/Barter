...
global $barter_a13;
$product_variant = $barter_a13->get_option( 'shop_products_variant' );
$product_subvariant = $product_variant === 'under'? ('products_subvariant_'.$barter_a13->get_option( 'shop_products_subvariant' ) ) : '';
...
$lazy_load_mode  = $barter_a13->get_option( 'shop_lazy_load_mode' );
